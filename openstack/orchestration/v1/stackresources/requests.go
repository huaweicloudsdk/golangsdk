...
func Get(c *golangsdk.ServiceClient, stackName, stackID, resourceName string) (r GetResult) {
...
func Metadata(c *golangsdk.ServiceClient, stackName, stackID, resourceName string) (r MetadataResult) {
...
func ListTypes(client *golangsdk.ServiceClient) pagination.Pager {
...
func Schema(c *golangsdk.ServiceClient, resourceType string) (r SchemaResult) {
...
func Template(c *golangsdk.ServiceClient, resourceType string) (r TemplateResult) {
